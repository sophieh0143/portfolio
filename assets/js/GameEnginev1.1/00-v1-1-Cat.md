...
<script type="module">
    ...
    import GameLevelCat from "{{site.baseurl}}/assets/js/GameEnginev1.1/GameLevelCat.js";
    ...
    const gameLevelClasses = [ GameLevelCat, GameLevelWater, GameLevelEnd, GameLevelOverworld ];
