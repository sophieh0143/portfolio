...
<div class="cloud-grid">
    <a href="OOP-checklist#writing-classes" class="cloud-btn">
        <span>Writing Classes</span>
    </a>
    <a href="OOP-checklist#methods-params" class="cloud-btn">
        <span>Methods & Parameters</span>
    </a>
    <a href="OOP-checklist#instantiation" class="cloud-btn">
        <span>Instantiation & Objects</span>
    </a>
    <a href="OOP-checklist#inheritance" class="cloud-btn">
        <span>Inheritance (Basic)</span>
    </a>
    <a href="OOP-checklist#overriding" class="cloud-btn">
        <span>Method Overriding</span>
    </a>
    <a href="OOP-checklist#super-calls" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="ControlStructures-checklist#iteration" class="cloud-btn">
        <span>Iteration (Loops)</span>
    </a>
    <a href="ControlStructures-checklist#conditionals" class="cloud-btn">
        <span>Conditionals</span>
    </a>
    <a href="ControlStructures-checklist#nested-conditions" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="DataTypes-checklist#numbers" class="cloud-btn">
        <span>Numbers</span>
    </a>
    <a href="DataTypes-checklist#strings" class="cloud-btn">
        <span>Strings</span>
    </a>
    <a href="DataTypes-checklist#booleans" class="cloud-btn">
        <span>Booleans</span>
    </a>
    <a href="DataTypes-checklist#arrays" class="cloud-btn">
        <span>Arrays</span>
    </a>
    <a href="DataTypes-checklist#objects-json" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="Operators-checklist#mathematical" class="cloud-btn">
        <span>Mathematical</span>
    </a>
    <a href="Operators-checklist#string-ops" class="cloud-btn">
        <span>String Operations</span>
    </a>
    <a href="Operators-checklist#boolean-expressions" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="IO-checklist#keyboard-input" class="cloud-btn">
        <span>Keyboard Input</span>
    </a>
    <a href="IO-checklist#canvas-rendering" class="cloud-btn">
        <span>Canvas Rendering</span>
    </a>
    <a href="IO-checklist#gameenv-config" class="cloud-btn">
        <span>GameEnv Config</span>
    </a>
    <a href="IO-checklist#api-integration" class="cloud-btn">
        <span>API Integration</span>
    </a>
    <a href="IO-checklist#async-io" class="cloud-btn">
        <span>Asynchronous I/O</span>
    </a>
    <a href="IO-checklist#json-parsing" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="Doc-checklist#code-comments" class="cloud-btn">
        <span>Code Comments</span>
    </a>
    <a href="Doc-checklist#mini-lesson" class="cloud-btn">
        <span>Mini-Lesson Docs</span>
    </a>
    <a href="Doc-checklist#code-highlights" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="Debugging-checklist#console-debugging" class="cloud-btn">
        <span>Console Debugging</span>
    </a>
    <a href="Debugging-checklist#hitbox-visualization" class="cloud-btn">
        <span>Hit Box Visuals</span>
    </a>
    <a href="Debugging-checklist#source-debugging" class="cloud-btn">
        <span>Source Debugging</span>
    </a>
    <a href="Debugging-checklist#network-debugging" class="cloud-btn">
        <span>Network Debugging</span>
    </a>
    <a href="Debugging-checklist#application-debugging" class="cloud-btn">
        <span>Application Storage</span>
    </a>
    <a href="Debugging-checklist#element-inspection" class="cloud-btn">
...
<div class="cloud-grid">
    <a href="Testing-checklist#gameplay-testing" class="cloud-btn">
        <span>Gameplay Testing</span>
    </a>
    <a href="Testing-checklist#integration-testing" class="cloud-btn">
        <span>Integration Testing</span>
    </a>
    <a href="Testing-checklist#api-error-handling" class="cloud-btn">
